...
class TestObservationOpportunity(unittest.TestCase):
    def test_observation_opportunity(self):
        ...
        opp = AtomicObservationOpportunity(
            task=task,
        ...
        self.assertIsInstance(opp, AtomicObservationOpportunity)
        self.assertIn(task, opp.tasks)
        ...
        self.assertRaises(AssertionError, AtomicObservationOpportunity,
                          task="task", # Invalid parent task
                          instrument_name="test_instrument",
                          accessibility=Interval(2000.0,3000.0),
                          min_duration= 0.0,
                          slew_angles=Interval(20.0, 45.0) )
        self.assertRaises(AssertionError, AtomicObservationOpportunity,
                          task={"tasks"}, # Invalid parent task
                          instrument_name="test_instrument",
                          accessibility=Interval(2000.0,3000.0),
                          min_duration= 0.0,
                          slew_angles=Interval(20.0, 45.0) )
    ...
    def test_observation_opportunity_can_merge(self):
        ...
        opp_1 = AtomicObservationOpportunity(
            task=task_1,
        ...
        opp_2 = AtomicObservationOpportunity(
            task=task_2,
            instrument_name="test_instrument_1",
            accessibility=Interval(2000.0,3000.0),  
            min_duration=10.0,
        ...
        self.assertFalse(opp_1.can_merge(other=opp_2, must_overlap=False)) 
        
        # Can only merge with non-overlapping access windows if specified
        opp_3 = AtomicObservationOpportunity(
            task=task_2,
            instrument_name="test_instrument_1",
            accessibility=Interval(3100.0,3600.0), # non-overlapping access window
            min_duration=10.0,
            slew_angles=Interval(20.0, 45.0),
        )
        ...
        opp_4 = AtomicObservationOpportunity(
            task=task_2,
            instrument_name="test_instrument_1",
            accessibility=Interval(2500.0,3600.0), # overlapping accessing window
            slew_angles=Interval(20.0, 45.0),
            min_duration=10.0,
            max_duration=500.0
        )
        ...
        # opp_5 = AtomicObservationOpportunity(
        #     task=task_2,
        #     instrument_name="test_instrument_1",
        #     accessibility=Interval(2950.0,3600.0), # accessing window only allows for 50.0 [s] of joint access
    ...
    #     opp_6 = AtomicObservationOpportunity(
    #         task=task_2,
    #         instrument_name="test_instrument_1",
    ...
    #     opp_7 = AtomicObservationOpportunity(
    #         task=task_2,
    #         instrument_name="test_instrument_1",
    ...
    #     opp_8 = AtomicObservationOpportunity(
    #         task=task_2,
    #         instrument_name="test_instrument_1",
    ...
    #     opp_9 = AtomicObservationOpportunity(
    #         task=task_2,
    #         instrument_name="test_instrument_1",
    #         accessibility=Interval(1000.0,3600.0), # access window fully contains `opp_1`
    ...
    def test_mutual_exclusivity(self):
        ...
        opp_2 = AtomicObservationOpportunity(
            task=task_2,    # different parent task             
            instrument_name="test_instrument_1",
            accessibility=Interval(2000.0,3000.0),
            min_duration= 0.0,
            slew_angles=Interval(20.0, 45.0)

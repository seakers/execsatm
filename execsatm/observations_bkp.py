...
class ObservationOpportunity:
    def __init__(self,
        ...
        **Arguments:**
        ...
        assert accessibility.left >= 0.0, \
            "Start of accessibility must be non-negative."
        ...
        **Arguments:**
        ...
        if not needs_extension:  # There is an overlap between the tasks' availability
            ...
            if (proceeding_obs.accessibility.is_subset(preceeding_obs.accessibility)
                ...
                accessibility_start = min(preceeding_obs.accessibility.right - preceeding_obs.min_duration, 
